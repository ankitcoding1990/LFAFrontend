...
declare var $: any;
@Component({
  selector: 'app-qsg-professionincome',
  templateUrl: './qsg-professionincome.component.html',
  styleUrls: ['./qsg-professionincome.component.css']
})
export class QsgProfessionincomeComponent implements OnInit {
  tabActive:any;
  order: string = 'name';
  public href: string = "";
  @Input() name: any;
  ...
  ngOnInit() {
    ...
    this.future_goalform = this.formBuilder.group({
      ...
      income: [''],
      profession: ['', Validators.required],
      start_date: ['',this.checkWorkMonth_future],
  ...
  get_user_basic_info() {
    ...
    this.dataService.getuserdetails(this.email).subscribe((data: {}) => {
      ...
      if (this.userdetails.result.gender === '' || this.userdetails.result.gender === null) {
        this.BasicProfileForm.get("gender").patchValue('');
      }
  ...
  delete_past_work(id: any) {
    ...
    Swal.fire({
      title: 'Are you sure?',
      text: "Delete Past work experience",
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
  ...
  edit_past_work(id: any, profession: any, income: any, date_from: any, date_to: any, description: any, current:any,other:any) {
    ...
    {
      this.past_work_other=true;
      this.pastworkform.get("profession").patchValue('Other');
      this.pastworkform.get("other").patchValue(other);
    }else{
       this.past_work_other=false;
  ...
  edit_future_goal(id: any, profession: any, income: any, start_date: any, end_date: any, description: any ,other:any) {
    
    if(profession == "Other" || profession == "other")
    {
      this.future_work_other=true;
      this.future_goalform.get("profession").patchValue('Other');
      this.future_goalform.get("other").patchValue(other);
    }else{
      this.future_work_other=false;
  ...
  saveuserlncome() {
    this.show_popup();
        this.save_btn_work=false;
        this.disable_btn_work=true;
  ...
  getuserincomedetails() {
    ...
    this.dataService.getuserprofessiondetails(this.loggeduser_id).subscribe((data: {}) => {
      this.userprofessionaldetails = data;
       if(this.userprofessionaldetails.data.other === "" || this.userprofessionaldetails.data.other === null)
   {
      this.userprofessionaldetails.data.other = this.userprofessionaldetails.data.profession
   }
    //   if(this.userprofessionaldetails.data === "" || this.userprofessionaldetails.data === null || this.userprofessionaldetails.data.other === '')
    //   {
    ...
    // if(this.userprofessionaldetails.data.other === null || this.userprofessionaldetails.data === '')
    //   {
